...
public class SorterWithThread2 implements Callable<List<Integer>> {
    List<Integer> list;
    ExecutorService executorService;

    SorterWithThread2(List<Integer> list, ExecutorService executorService) {
        this.list = list;
...
//        ExecutorService executorService = Executors.newCachedThreadPool();
        ...
        // t = 0  t = 0;
        Future<List<Integer>> sortedLeftFuture = executorService.submit(new SorterWithThread2(left, executorService)); // a: t = 5 // t = 5
        // line 40 started executing at t = 0
        Future<List<Integer>> sortedRightFuture = executorService.submit(new SorterWithThread2(right, executorService)); // b: t = 10; t = 5
